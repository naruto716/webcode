...
import CheckboxButton from "../../app/Components/CheckboxButtons.tsx";
    ...
    return (
        <Grid container columnSpacing={4}>
            <Grid item xs={3}>
                ...
                <Paper sx={{mb: 2, p: 2}}>
                    <CheckboxButton items={brands} checked={productParams.brands}
                                    onChange={(items: string[]) => dispatch(setProductParams({brands: items}))}/>
                </Paper>
                <Paper sx={{mb: 2, p: 2}}>
                    <FormGroup>
                        <CheckboxButton items={types} checked={productParams.types}
            ...
            <Grid item xs={9} sx={{mb: 2}}>
                {metaData && 
                <AppPagination metaData={metaData} onPageChange={(page: number) => dispatch(setPageNumber(page))} />
                }
            </Grid>
        </Grid>
    )
